...
class TeacherDiscussion extends StatefulWidget {
  const TeacherDiscussion({super.key});

  @override
  State<TeacherDiscussion> createState() => _TeacherDiscussionState();
}

class _TeacherDiscussionState extends State<TeacherDiscussion> {
  TextEditingController messageController=TextEditingController();
  ImagePicker imagePicker=ImagePicker();
  firebase_storage.FirebaseStorage storage=firebase_storage.FirebaseStorage.instance;
  File? file;
  String messageType="normal";
  Color color=Color.fromRGBO(248, 125, 125, 1.0);
  var databaseReference=FirebaseDatabase.instance.ref("Teacher Discussion");
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Color.fromRGBO(246, 235, 235, 1.0),
      appBar: AppBar(
        title: Text("Teacher Discussion"),
      ),
